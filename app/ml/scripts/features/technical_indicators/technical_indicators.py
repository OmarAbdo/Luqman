...
class TechnicalIndicators:
    ...
    def load_data(self):
        ...
        """
        file_path = f"app/ml/data/{self.ticker}/stock/{self.ticker}_5min_raw.csv"
    ...
    def save_to_csv(self):
        ...
        """
        output_path = f"app/ml/data/{self.ticker}/stock/{self.ticker}_5min_technical_indicators.csv"
