...
Usage Example:
--------------
1. Ensure all chunk CSV files are located under app/ml/data/[ticker]/stock/chunks/.
...
class CSVDataMerger:
    ...
    Attributes:
        ...
        base_dir (str): The base directory where data is stored, e.g., "app/ml/data".
    ...
    def __init__(self, ticker: str, interval: str, base_dir: str = "app/ml/data"):
        """
        ...
        Args:
            ticker (str): The stock ticker symbol, e.g., "AAPL".
            interval (str): The data interval, e.g., "5min".
            base_dir (str, optional): The base directory path. Defaults to "app/ml/data".
        """
        self.ticker = ticker
