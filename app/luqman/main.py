...
from components.stock_price.alpha_vantage import AlphaVantageIntradayFetcher
from components.technical_indicators.technical_indicators import (
    TechnicalIndicators,
)
from components.technical_sentiment_indicators.technical_sentiment_indicators import (
...
class Main:
    ...
    def __init__(self, ticker: str, config: dict):
        ...
        self.base_dir = (
            Path(config.get("base_dir", "app/luqman/data")) / self.ticker / "stock"
        )
        self.chunks_dir = self.base_dir / "chunks"
        self.models_dir = (
            Path(config.get("models_dir", "app/luqman/models")) / self.ticker
        )
        ...
        self.merger = CSVDataMerger(
            ticker=self.ticker,
            interval=config.get("interval", "5min"),
            base_dir=config.get("base_dir", "app/luqman/data"),
        )
...
if __name__ == "__main__":
    ...
    config = {
        ...
        "models_dir": "app/luqman/models",  # Directory to save trained models
