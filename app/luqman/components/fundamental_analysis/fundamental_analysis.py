# components/fundamental_analysis.py
...
from components.fundamental_analysis.financial_metrics import (
    calculate_pe,
    calculate_pb,
    calculate_ev_ebitda,
    calculate_peg_ratio,
...
class FundamentalAnalysis:
    ...
    def __init__(self):
        ...
        self.data = None
        self.financial_data = {}
        self.data_path = os.path.join("app/luqman/data", self.ticker, "fundamental")
