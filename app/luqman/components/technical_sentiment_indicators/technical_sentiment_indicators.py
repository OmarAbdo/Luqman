...
class TechnicalSentimentIndicators:
    ...
    def load_data(self):
        ...
        """
        file_path = f"app/luqman/data/{self.ticker}/stock/{self.ticker}_5min_technical_indicators.csv"
    ...
    def save_analysis(self):
        ...
        """
        output_path = f"app/luqman/data/{self.ticker}/stock/{self.ticker}_5min_technical_sentimental_indicators.csv"
