...
class StockPrice:
    ...
    The unit tests under app/luqman/tests ensure the reliability of our data fetching, storage, and handling. These tests also serve as documentation of expected behavior and provide confidence in future refactoring efforts.
    """
    ...
    def __init__(self):
        self.base_data_path = os.path.join(
            "app/luqman/data/", self.TARGET_TICKER, "stock"
        )
